                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="input" class="form-control description"
                                            ...
                                            rows=" 8"><?php echo $prod->description?> </textarea>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group"> <label for="">Giá sản phẩm</label> <input type="number"
                                                name="price" class="
                                                form-control" value="<?php  echo $prod->price?>"
                                                placeholder="Input name">
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <div class="form-group"> <label for="">Giá khuyến mãi</label> <input
                                                type="number" name="sale" class="form-control"
                                                value="<?php  echo $prod->sale?>" placeholder="Input name"> </div>
                                    </div>
                                    <div class="form-group">
